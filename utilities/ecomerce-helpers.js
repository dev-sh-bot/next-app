...
export function calculateAmount(obj) {
    return Object.values(obj)
        .reduce((acc, { quantity, price, discount, variation, variationIndex }) => acc + quantity * (discount ? variation[variationIndex].price - discount : variation[variationIndex].price), 0)
        .toFixed(2);
}
