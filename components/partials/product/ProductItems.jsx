...
const ProductItems = ({ products, columns = 4, collectionSlug }) => {
            ...
            if (listView) {
                const items = productItems.map((item) => (
                    <div className={classes} key={item.id}>
                        <Product product={item} collectionSlug={collectionSlug} userRole={UserObj} />
                    </div>
                ));
                productItemsView = (
                ...
                productItemsView = productItems.map((item) => (
                    <ProductWide product={item} key={item.id} collectionSlug={collectionSlug} userRole={UserObj} />
                ));
            }
        } else {
