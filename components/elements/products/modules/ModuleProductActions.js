...
const ModuleProductActions = ({ product, ecomerce }) => {
    ...
    // console.log("product",product.variation[0].stock)

    function handleAddItemToCart(e) {
        e.preventDefault();
        addItem({ id: product.id, quantity: 1, shopId:product.shop.id, stock:parseInt(product.variation[0].stock),variationIndex: 0 }, ecomerce.cartItems, 'cart');
    }
