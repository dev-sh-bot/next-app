        ...
        const items = cartItems.map((item) => (
            <tr key={item.id}>
                ...
                <td data-label="price" className="price">
                    Rs{item.discount ? item.variation[item.variationIndex].price - item.discount : item.variation[item.variationIndex].price}
                </td>
                ...
                <td data-label="total">
                    <strong>Rs{((item.discount ? item.variation[item.variationIndex].price - item.discount : item.variation[item.variationIndex].price) * item.quantity).toFixed(2)}</strong>
                </td>
                <td>
