                ...
                <div className="row">
                    <div className="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 ">
                        <div className="ps-block__thumbnail">
                            <img src="/static/img/app.png" alt="Real_Bazar" />
                        </div>
                    </div>
                    <div className="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 ">
                        <div className="ps-block__content">
                            <h3>Download Real Bazar App Now!</h3>
                            <p>
                            ...
                            <p className="download-link">
                                <a href="#">
                                    <img src="/static/img/google-play.png" alt="Real_Bazar" />
                                </a>
                                <a href="#">
                                    <img src="/static/img/app-store.png" alt="Real_Bazar" />
                                </a>
                            </p>
                        </div>
                    </div>
