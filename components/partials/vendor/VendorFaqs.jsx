    ...
    <div className="ps-section--vendor ps-vendor-faqs">
        <div className="container">
            <div className="ps-section__header">
                ...
                <h4>Here are some common questions about selling on Real Bazar</h4>
            </div>
            <div className="ps-section__content">
                <div className="row">
                    <div className="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 ">
                        <figure>
                            <figcaption>How do fees work on Real Bazar?</figcaption>
                            <p>
                                Joining and starting a shop on Real Bazar is free. There are three
                        ...
                        <figure>
                            ...
                            <p>
                                It’s easy to set up a shop on Real Bazar. Create an Real Bazar account
                                ...
                                want to pay your Real Bazarfees).
                            </p>
                        </figure>
                    </div>
                    <div className="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 ">
                        <figure>
                            ...
                            <p>
                                ...
                                Real Bazar will be deposited into your PayPal account. We encourage
                        ...
                        <figure>
                            <figcaption>What can I sell on Real Bazar?</figcaption>
                        </figure>
                        <p>
                            Real Bazar provides a marketplace for crafters, artists and collectors to
